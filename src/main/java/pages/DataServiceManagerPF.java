...
public class DataServiceManagerPF extends ssdSandbox {
	
	// Constructor
	public DataServiceManagerPF() {
		...
		private WebElement userNameOID;
	 	...
	 	public DataServiceManagerPF enterUserNameOID(String UserNameValue) {
	    	try {
	    		userNameOID.click();
	    		userNameOID.clear();
	 	...
	 	public DataServiceManagerPF enterPasswordOID(String PasswordValue) {
	    	try {
	    		PasswordOID.click();
	    		PasswordOID.clear();
